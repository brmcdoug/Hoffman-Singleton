...
# r00
clab tools vxlan create --remote 198.18.133.105 --id 1010 --link r00-Gi0-0-0-7
clab tools vxlan create --remote 198.18.133.105 --id 1011 --link r00-Gi0-0-0-8

# r01
clab tools vxlan create --remote 198.18.133.105 --id 1012 --link r01-Gi0-0-0-5 # r28 gi0
clab tools vxlan create --remote 198.18.133.105 --id 1013 --link r01-Gi0-0-0-6 # r29 gi0
clab tools vxlan create --remote 198.18.133.105 --id 1014 --link r01-Gi0-0-0-7
clab tools vxlan create --remote 198.18.133.105 --id 1015 --link r01-Gi0-0-0-8
